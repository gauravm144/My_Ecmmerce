                    ...
                    <div class="post-meta">
                        ...
                        <div class="we-video-info">
                            <ul>
                                ...
                                <i><button class="cart" id="1" style="border-radius: 12px;width: 100%;border: none;background-color: antiquewhite;">Add To wishlist</button></i>
...
<!-- </div>  -->
    ...
    $sql = "SELECT * FROM postshow,postcategory";
            ...
            <div class="central-meta item">
                <div class="user-post">
                    <div class="friend-info">
                        ...
                        <div class="friend-name">
                                <ins><a href="detail.php?id='.$row["postID"].'" title="">'.$row["title"].'</a></ins> 
                            <span>published: june,2 2018 19:PM</span>
                        </div>
                        <div class="post-meta">
