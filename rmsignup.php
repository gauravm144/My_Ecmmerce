...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
	...
	else
	{
		...
		$sql="INSERT INTO userprofile (email,password,name,timeaccount,secques) VALUES ('$email','$password','$name',current_timestamp(),'".$_POST['secques']."');";
		 $conn->query($sql);
		...
		while($row=$result->fetch_assoc())
		{
				...
				// else
				// {
				setcookie("usserid",$row["userID"],"/","localhost");
				// }
				...
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">New Account</h3>
					<form action="signup.php" class="login-form" method="POST">
						...
						<div class="form-group d-flex">
							<input type="text" class="form-control rounded-left" placeholder="Confirm Password" name="cpassword"required>
						</div>
						<div class="form-group d-flex">
