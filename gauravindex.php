...
<div class="theme-layout">
												...
												<div class="we-video-info">
													<ul>
														...
														<i style="margin-right: 2px;">
															...
															<i id="hulu" onclick="ju()" class="ti-heart"></i>
																<ins>2.2k</ins>
															</span>
														</i>
														<i style="margin-right: 2px;">
														...
														<i style="border:none;outline: 0;padding: 12px;"><button style"align:right;" class="cart" id="';echo $i;echo'">wishlist</button></i>
 ...
 function ju() {
    document.getElementById("hulu").className="fa fa-heart";
    console.log("kl");
}
